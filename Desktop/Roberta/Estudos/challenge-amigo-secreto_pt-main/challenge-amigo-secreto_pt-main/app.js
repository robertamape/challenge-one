...
function adicionarAmigo() {
    let nome = inputNomeAmigo.value.trim(); // Remover espaços em branco
    if (nome !== '') {
        ...
        inputNomeAmigo.focus();
        alert("Insira um nome válido!"); // Exibir mensagem de erro com alert
    }
}
...
function sortearAmigo() {
    if (arrayAmigos.length >= 1) {
        ...
        alert("Não há pessoas para o sorteio!"); // Exibir mensagem de erro com alert
    }
}
